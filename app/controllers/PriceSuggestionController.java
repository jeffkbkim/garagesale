...
public class PriceSuggestionController extends Controller {
    ...
    public Result createSale() {
        ...
        return redirect(PriceSuggestionController.getSales());
    }
    ...
    public Result addRole() {
        ...
        return redirect(PriceSuggestionController.renderSaleRolesPage(sale.getId()));
    }
    ...
    public Result getSales() {
        ...
        return ok(sale.render(user, sales));
    }
