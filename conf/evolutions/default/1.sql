...
alter table sale add constraint fk_sale_user_5 foreign key (user_id) references user (id) on delete restrict on update restrict;
create index ix_sale_user_5 on sale (user_id);
